(() => {
  ...
  function shell(content,title='Blink',right=''){
    ...
    return `<div class="app-shell">
      <aside class="sidebar">
        <button class="nav-btn brand" data-nav="/feed"><span class="mark">B</span><span>Blink</span></button>
