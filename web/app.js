(() => {
  ...
  function shell(content,title='Blink',right=''){
    ...
    return `<div class="app-shell">
      <aside class="sidebar">
        <button class="nav-btn brand" data-nav="/feed"><img class="mark" src="${LOGO_URL}" alt="" aria-hidden="true"><span>Blink</span></button>
