package com.blinkng.shared.notification

/**
 * Platform-neutral Blink notification contract compiled by Android and Windows.
 *
 * Keep wire aliases and preference categories here so a backend notification means
 * the same thing on every Blink client. Unknown values remain visible as a safe
 * social fallback instead of crashing an older client.
 */
enum class BlinkNotificationKind(
    ...
    companion object {
        fun fromWire(raw: String?): BlinkNotificationKind {
