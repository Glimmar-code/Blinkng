...
idx1 = content.find('suspend fun createFeedPost(')
idx2 = content.find('suspend fun uploadPostMedia(', idx1)
if idx2 == -1: idx2 = content.find('// ============================================================', idx1)
...
"""
content = content[:idx1] + new_createFeedPost + content[idx2:]
