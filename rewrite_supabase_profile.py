            ...
            try {
                ...
                val json =
                    JSONObject().apply {
                        ...
                        put("custom_status", profile.availability.label)
...
pattern = r'    suspend fun updateProfile\(.*?return@withContext false\n            \}\n        \}'
content = re.sub(r'    suspend fun updateProfile\([\s\S]*?\} catch \(e: Exception\) \{\n[\s\S]*?return@withContext .*?\n            \}\n        \}', new_update_profile, content)
