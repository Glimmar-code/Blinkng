...
| 2026-09-25 | Premium feed structure v3 | Android Home now matches the approved content-first structure: persistent World Rank and Blink Coin chips, Search/Game/Notifications/Menu actions, For You/Following-only feed tabs, Home/Reels/Aluta Market/Connect/Message bottom navigation, clearer post-card hierarchy, larger card rhythm, and Create/AI kept clear of navigation | Windows mirrors the same product priority with live rank/coin shortcuts, Game access in the top bar, Aluta Market promoted near Home/Reels, and Messages/Connect remaining primary destinations | Presentation/navigation only. Feed/reel ranking, qualified/repeated views, Supabase contracts, caching, sponsored insertion, coins, messaging semantics, marketplace data, and game logic are unchanged |
